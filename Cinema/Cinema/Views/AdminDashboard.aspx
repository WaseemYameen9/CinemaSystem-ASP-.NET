<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="Cinema.Views.AdminDashboard" %>
...
<body>
    ...
    <form id="form1" runat="server">
		...
		<table class="auto-style22">
			<tr>
				<td class="auto-style16">Enter Movie Name:</td>
				<td class="auto-style17">
					<input id="Nametxt" class="auto-style21" type="text" runat="server"/></td>
				<td class="auto-style18"></td>
			</tr>
			<tr>
				<td class="auto-style13">Enter Desription:</td>
				<td class="auto-style14">
					<input id="DescriptionTxt" class="auto-style21" type="text" runat="server" /></td>
				<td class="auto-style15"></td>
			</tr>
			<tr>
				<td class="auto-style10">Enter Price Per Seat:</td>
				<td class="auto-style11">
					<input id="PricePerSeatTxt" class="auto-style20" type="text" runat="server"/></td>
				<td class="auto-style12"></td>
			</tr>
			<tr>
				<td class="auto-style10">Enter Status:</td>
				<td class="auto-style11">
					<input id="statusTxt" class="auto-style20" type="text" runat="server"/></td>
				<td class="auto-style12"></td>
			</tr>
		</table>
